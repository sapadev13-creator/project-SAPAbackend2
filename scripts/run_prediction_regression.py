...
CASES = [
    ...
    ("luapan kemarahan yang sulit ditahan dan marah meledak", "N", "Marah Meledak"),
    ("emosi meluap dan emosi tak terkendali saat tekanan", "N", "Emosional Meluap"),
    ("sangat kritis dan suka menyerang orang dengan nada sinis", "N", "Kritis"),
    ("penuh kebencian dan membenci orang yang menyakiti", "N", "Kebencian"),
    ("bacot mulu dan tolol banget di grup chat", "N", "Kritis"),
    ("bangsat lu emang keparat kaga pernah inget dosa", "N", "Kebencian"),
    ("mengacau banget dan ngamuk terus pas emosi", "N", "Marah Meledak"),
    ("hidup suram dan bobrok banget mental hancur", "N", "Luka Emosional"),
